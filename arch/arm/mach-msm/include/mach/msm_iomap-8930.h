...
#define MSM8930_RPM_SIZE		(SZ_8K + SZ_16K)
...
#define MSM_GPU_SNAP_SHOT_3D0_PHYS  0x8F780000
#define MSM_GPU_SNAP_SHOT_3D0_SIZE  SZ_512K 

#ifdef CONFIG_MSM8930_ONLY
#define MSM_RAM_CONSOLE_BASE    0x8F900000
#define MSM_RAM_CONSOLE_SIZE    (SZ_1M - SZ_128K) 

#undef MSM_HTC_DEBUG_INFO_PHYS
#undef MSM_HTC_DEBUG_INFO_SIZE

#define MSM_HTC_DEBUG_INFO_PHYS     (MSM_RAM_CONSOLE_BASE + MSM_RAM_CONSOLE_SIZE)
#define MSM_HTC_DEBUG_INFO_SIZE     (SZ_128K)

#undef MSM_TZLOG_PHYS
#undef MSM_TZLOG_SIZE

#define MSM_TZLOG_PHYS          MSM_HTC_DEBUG_INFO_PHYS 
#define MSM_TZLOG_SIZE          (SZ_64K)

#undef MSM_TZ_DOG_BARK_REG_SAVE_PHYS
#undef MSM_TZ_DOG_BARK_REG_SAVE_SIZE

#define MSM_TZ_DOG_BARK_REG_SAVE_PHYS   (MSM_HTC_DEBUG_INFO_PHYS + MSM_TZLOG_SIZE) 
#define MSM_TZ_DOG_BARK_REG_SAVE_SIZE   (SZ_4K)

#undef MSM_KERNEL_FOOTPRINT_PHYS
#undef MSM_KERNEL_FOOTPRINT_SIZE
...
#undef MSM_KALLSYMS_SAVE_PHYS
#undef MSM_KALLSYMS_SAVE_SIZE

#define MSM_KALLSYMS_SAVE_PHYS      (MSM_KERNEL_FOOTPRINT_PHYS + MSM_KERNEL_FOOTPRINT_SIZE) 
#define MSM_KALLSYMS_SAVE_SIZE      (MSM_HTC_DEBUG_INFO_SIZE - MSM_TZLOG_SIZE - MSM_TZ_DOG_BARK_REG_SAVE_SIZE- MSM_KERNEL_FOOTPRINT_SIZE)   
#endif
